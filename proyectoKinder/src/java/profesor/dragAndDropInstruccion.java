...
public class dragAndDropInstruccion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String imagenNuevo = "";
        /*(String)request.getParameter("imagenNuevo");*/
        session.setAttribute("imagenNuevo", imagenNuevo);
        String audioImagenNuevo = "";
        /*(String) request.getParameter("audioImagenNuevo");*/
        ...
        out.println("<h2>Selecciona o arrastra un archivo .mp3</h2>");
        //Se sube archivo
