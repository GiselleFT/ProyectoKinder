...
public class adminEjercicio1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Ejercicio 1: Seleccionar Inicio de Mezclas consonanticas</title>");     
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Ejercicio 1: Seleccionar Inicio de Mezclas consonanticas</h1>");
            
            //Altas, bajas y cambios de ejercicios
            out.println("<form action='crearEjercicio1' method='get'>");
            out.println("<input type='submit' value='Crear ejercicio'/><br />");
            out.println("</form>");
            
            
            out.println("<form action='eliminarEjercicio1' method='get'>");
            out.println("<input type='submit' value='Eliminar ejercicio'/><br />");
            out.println("</form>");
            
            
            out.println("<form action='modificarEjercicio1' method='get'>");
